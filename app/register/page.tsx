    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#09090B' }}>
      ...
      <div style={{ textAlign: 'center', position: 'relative', zIndex: 1 }}>
        ...
        <div className="card" style={{ minWidth: '360px', textAlign: 'left', border: '1px solid rgba(99,102,241,0.2)' }}>
          ...
          <button onClick={handle} className="btn-brand" style={{ width: '100%', padding: '14px', fontSize: '15px' }}>
            {t.nav.signUp}
          </button>
          <p style={{ color: '#52525B', fontSize: '12px', textAlign: 'center', marginTop: '16px' }}>Register route is live.</p>
        </div>
